<?php return array (
  ...
  'user.dateRegistered' => 'Ngày đăng kí',
  ...
  'user.login.registrationComplete.newSubmission' => 'Tạo một bài đăng mới',
  ...
  'user.login.resetPassword' => 'Khôi phục mật khẩu',
  'user.logOut' => 'Đăng xuất',
  'user.logOutAs' => 'Đăng xuất với',
  'user.hello' => 'Xin chào, ',
  'user.mailingAddress' => 'Địa chỉ email',
  'user.myAccount' => 'Tài khoản của tôi',
  'user.name' => 'Tên',
  'user.password' => 'Mật khẩu',
  'user.repeatPassword' => 'Nhập lại mật khẩu',
  ...
  'user.login.registerNewAccount' => 'Đăng kí',
  ...
  'user.register.form.privacyConsent' => 'Vâng, tôi đã đồng ý với tất cả các điều khoản theo <a href="{$privacyUrl}" target="_blank">các cam kết trên</a>.',
  'user.register.form.emailConsent' => 'Vâng, tôi muốn được thông báo về các ấn phẩm và thông báo mới.',
