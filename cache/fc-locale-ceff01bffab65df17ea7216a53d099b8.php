<?php return array (
  ...
  'admin.contexts.confirmDelete' => 'Êtes-vous certain de vouloir supprimer définitivement cette revue et tout son contenu?',
  ...
  'admin.mergeUsers.confirm' => 'Êtes-vous certain de vouloir fusionner le compte portant le nom d\'utilisateur "{$oldAccountCount}" avec le compte portant le nom d\'utilisateur "{$newUsername}"? Le compte portant le nom d\'utilisateur "{$oldAccountCount}" sera supprimé. Cette action n\'est pas réversible.',
  ...
  'admin.settings.defaultMetricDescription' => 'Votre installation OJS est paramétrée pour enregistrer plus d\'une mesure d\'utilisation. Les statistiques d\'utilisation seront affichées dans plusieurs contextes. Il y a des cas où seulement une statistique d\'utilisation doit être utilisée, ex. pour afficher une liste ordonnée des articles les plus utilisés ou classer les résultats de recherche. Veuillez sélectionnez l\'une des mesures comme celle par défaut.',
  'admin.languages.confirmDisable' => 'Êtes-vous certain de vouloir désactiver cette instance locale? Cela pourrait avoir un impact sur toute revue utilisant présentement cette instance.',
  'admin.contexts.form.titleRequired' => 'Un titre est requis.',
  'admin.presses.createInstructions' => 'Le rôle de directeur de la revue vous sera automatique attribué. Après avoir créer une nouvelle revue, vous serez dirigé vers son assistant de configuration afin de terminer la configuration initiale de la revue.',
  ...
  'admin.languages.downloadUnavailable' => '<p>Le téléchargement de fichiers de langue depuis le serveur Web Public Knowledge Project n\'est pas disponible actuellement car: </p>
<ul>
