<?php return array (
  ...
  'contactEmail' => 'iammaytinhdibo@gmail.com',
  'contactName' => 'Tran Cuong',
  'contactPhone' => '961538337',
...
<a href="{$contextUrl}">{$contextName}</a>',
  ...
  'authorInformation' => 
  array (
    'en_US' => 'Interested in submitting to this journal? We recommend that you review the <a href="http://localhost/JPRP/index.php/JPRP/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="http://localhost/JPRP/index.php/JPRP/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="http://localhost/JPRP/index.php/JPRP/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="http://localhost/JPRP/index.php/index/login">log in</a> and begin the five-step process.',
    'vi_VN' => 'Interested in submitting to this journal? We recommend that you review the <a href="http://localhost/JPRP/index.php/JPRP/about">About the Journal</a> page for the journal\'s section policies, as well as the <a href="http://localhost/JPRP/index.php/JPRP/about/submissions#authorGuidelines">Author Guidelines</a>. Authors need to <a href="http://localhost/JPRP/index.php/JPRP/user/register">register</a> with the journal prior to submitting or, if already registered, can simply <a href="http://localhost/JPRP/index.php/index/login">log in</a> and begin the five-step process.',
  ),
  ...
  array (
    ...
    'vi_VN' => 'This journal permits and encourages authors to post items submitted to the journal on personal websites or institutional repositories both prior to and after publication, while providing bibliographic details that credit, if applicable, its publication in this journal.',
  ),
  'clockssLicense' => 
  array (
    ...
    'vi_VN' => 'This journal utilizes the CLOCKSS system to create a distributed archiving system among participating libraries and permits those libraries to create permanent archives of the journal for purposes of preservation and restoration. <a href="http://clockss.org/">More...</a>',
  ),
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
    ...
    'vi_VN' => 'The copyediting stage is intended to improve the flow, clarity, grammar, wording, and formatting of the article. It represents the last chance for the author to make any substantial changes to the text because the next stage is restricted to typos and formatting corrections.
...
<li><strong>Final copyedit.</strong> The journal copy editor will verify changes made by the author and incorporate the responses to the author queries to create a final manuscript. When finished, the copy editor will upload the final document through the journal Web site and alert the layout editor to complete formatting.</li>
  ...
  'description' => 
  array (
    'en_US' => '<p><span style="font-weight: 400;">The&nbsp;</span><em><span style="font-weight: 400;">Journal</span></em>&nbsp;<em><span style="font-weight: 400;">of</span></em>&nbsp;<em><span style="font-weight: 400;">Science</span></em><span style="font-weight: 400;">&nbsp;was established in 1985 for the publication of national and international research papers in all fields of natural sciences and technology, social sciences and humanities. Since then, the journal has grown in quality, size and scope and now comprises a dozen of serials spanning academic research.</span></p>
<p><span style="font-weight: 400;">With the rapid expansion of the field of Economics, the VNU&nbsp;</span><em><span style="font-weight: 400;">Journal</span></em>&nbsp;<em><span style="font-weight: 400;">of</span></em>&nbsp;<em><span style="font-weight: 400;">Science</span></em><span style="font-weight: 400;">&nbsp;is delighted to announce the launch of the&nbsp;</span><em><span style="font-weight: 400;">VNU Journal of Science:&nbsp;Education Research&nbsp;</span></em><em><span style="font-weight: 400;">(JS: ER)&nbsp;</span></em><span style="font-weight: 400;">since 2013. This serial publication provides researchers with the opportunity to publish research covering aspects in these areas in the popular&nbsp;</span><em><span style="font-weight: 400;">VNU Journal of Science</span></em><span style="font-weight: 400;">&nbsp;series.</span></p>
<p><span style="font-weight: 400;">As a fully open access publication, the journal will provide maximum exposure for published articles, making the research available to all to read and share. The journal will be published quarterly in March, June, September and December.</span></p>
<p><strong>Scope</strong></p>
<p><span style="font-weight: 400;">JS: ER&nbsp;is an open access journal publishing double-blinded peer-reviewed research papers, communications and reviews dealing with Education management, Education quality, Education reform, Educational research, Education studies and Teaching and learning.</span></p>
<p><strong>Peer Review Process</strong></p>
<p><span style="font-weight: 400;">Any manuscript followed the journal’s scope and author guideline will be assigned to the managing editors. All manuscripts have undergone editorial screening and anonymous double-blind peer-review by the at least one independent expert in the field. The managing editor makes an editorial decision, which is subject to endorsement by the Editor – in Chief.</span></p>
<p><strong>Abstracting and Indexing</strong></p>
<p><img style="width: 100%; max-width: 512px;" src="/EAB//public/site/images/admin/logo2.png" alt=""></p>',
  ),
  'homepageImage' => 
  array (
    'en_US' => 
    array (
      'name' => 'bookcover0001585-no-genre.jpg',
      'uploadName' => 'homepageImage_en_US.jpg',
      'width' => 750,
      'height' => 1200,
      'dateUploaded' => '2019-05-03 08:34:57',
      'altText' => '',
    ),
  ),
  ...
  array (
    ...
    'vi_VN' => 'We encourage research librarians to list this journal among their library\'s electronic journal holdings. As well, it may be worth noting that this journal\'s open source publishing system is suitable for libraries to host for their faculty members to use with journals they are involved in editing (see <a href="http://pkp.sfu.ca/ojs">Open Journal Systems</a>).',
  ),
  'lockssLicense' => 
  array (
    ...
    'vi_VN' => 'This journal utilizes the LOCKSS system to create a distributed archiving system among participating libraries and permits those libraries to create permanent archives of the journal for purposes of preservation and restoration. <a href="http://www.lockss.org/">More...</a>',
  ),
  'name' => 
  array (
    'en_US' => 'JPRP - Tạp chí khoa học Bệnh Viện Nhi Trung Ương',
  ),
  'openAccessPolicy' => 
  array (
    ...
    'vi_VN' => 'This journal provides immediate open access to its content on the principle that making research freely available to the public supports a greater global exchange of knowledge.',
  ),
  'pageHeaderLogoImage' => 
  array (
    'en_US' => 
    array (
      ...
      'width' => 2375,
      'height' => 325,
      'dateUploaded' => '2019-05-03 08:33:58',
      'altText' => '',
    ),
    'vi_VN' => 
    array (
      'name' => 'asd.png',
      'uploadName' => 'pageHeaderLogoImage_vi_VN.png',
      'width' => 2375,
      'height' => 325,
      'dateUploaded' => '2019-05-07 03:37:22',
      'altText' => '',
    ),
  ),
  'privacyStatement' => 
  array (
    ...
    'vi_VN' => 'The names and email addresses entered in this journal site will be used exclusively for the stated purposes of this journal and will not be made available for any other purpose or to any other party.',
  ),
  'proofInstructions' => 
  array (
    ...
    'vi_VN' => '<p>The proofreading stage is intended to catch any errors in the galley\'s spelling, grammar, and formatting. More substantial changes cannot be made at this stage, unless discussed with the Section Editor. In Layout, click on VIEW PROOF to see the HTML, PDF, and other available file formats used in publishing this item.</p>
	<h4>For Spelling and Grammar Errors</h4>
  ...
  'readerInformation' => 
  array (
    'en_US' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="http://localhost/JPRP/index.php/JPRP/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="http://localhost/JPRP/index.php/JPRP/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
    'vi_VN' => 'We encourage readers to sign up for the publishing notification service for this journal. Use the <a href="http://localhost/JPRP/index.php/JPRP/user/register">Register</a> link at the top of the home page for the journal. This registration will result in the reader receiving the Table of Contents by email for each new issue of the journal. This list also allows the journal to claim a certain level of support or readership. See the journal\'s <a href="http://localhost/JPRP/index.php/JPRP/about/submissions#privacyStatement">Privacy Statement</a>, which assures readers that their name and email address will not be used for other purposes.',
  ),
  'refLinkInstructions' => 
  array (
    ...
    'vi_VN' => '<h4>To Add Reference Linking to the Layout Process</h4>
	<p>When turning a submission into HTML or PDF, make sure that all hyperlinks in the submission are active.</p>
	<h4>A. When the Author Provides a Link with the Reference</h4>
	<ol>
	<li>While the submission is still in its word processing format (e.g., Word), add the phrase VIEW ITEM to the end of the reference that has a URL.</li>
