...
<a class="btn btn-borders btn-xs btn {if $isSupplementary}btn-default{else}btn-outline{/if} {$type}" role="button" href="{url|escape page=$page op="view" path=$parentId|to_array:$galley->getBestGalleyId($currentJournal)}">
