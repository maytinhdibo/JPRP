...
<div class="pkp_structure_page">
    ...
    <header class="pkp_structure_head" id="headerNavigationContainer" role="banner">
        ...
        {if $currentContext}
            <nav class="pkp_navigation_primary_row navDropdownMenu"
        ...
        <nav class="pkp_navigation_user_wrapper navDropdownMenu" id="navigationUserWrapper"
             aria-label="{translate|escape key="common.navigation.user"}">
            <ul id="navigationUser" class="pkp_navigation_user pkp_nav_list">
                {if $isUserLoggedIn}
                    <li class="profile {if $unreadNotificationCount} has_tasks{/if}" aria-haspopup="true"
                        aria-expanded="false">
